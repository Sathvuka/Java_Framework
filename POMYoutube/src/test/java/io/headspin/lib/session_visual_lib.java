...
import static io.headspin.Tests.YoutubeTest.test_name;
import static io.headspin.lib.Config.*;
import static io.headspin.utils.ConfigVar.appPackage;
                ...
                if (label.containsKey("segment_start") && label.containsKey("segment_end")) {
                    ...
                    try {
                        if (screen_change_list != null && !screen_change_list.isEmpty()) {
                            ...
                            if (segmentStart >= 0 && segmentStart < screen_change_list.size() && segmentEnd >= 0 && segmentEnd < screen_change_list.size()) {
